...
function simpleslides_scripts() {
  ...
  wp_enqueue_script( 'bbq', get_template_directory_uri() . '/js/bbq.min.js', array(), '1.3pre', true);
  wp_enqueue_script( 'simpleslides', get_template_directory_uri() . '/js/simpleslides.js', array('jquery','highlightjs','bbq'), '1.0.0', true );
}
